...
//     // },
//     'postcss-pxtorem': {
//       // amfe/lib-flexible 的rem适配方案 把一行分为10份 每份就是十分之一
//     //   所以rootValue应该设置为你的设计稿宽度的十分之一 我们的设计稿是750 所以应该设置为750/10=75 但是vant建议设置为37.5 以为vant是基于375写的
//     //   rootValue: 37.5,
...
//         //   数字:固定的数值
//         // 函数:可以动态处理返回
//         // postcss-pxtorem处理每个css文件的时候都会来调用这函数
